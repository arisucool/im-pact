...
export class ActionTestHelper {
   ...
   * テスト用ツイートの取得
   */
  public static getTweet(): ClassifiedTweet {
    return {
      id: 0,
      ...
      classifiedAt: new Date('Mon Jan 25 19:00:00 +0000 2021'),
      socialAccount: null,
      topic: null,
   ...
   * テスト用ツイートの取得
   */
  public static getTweets(): ClassifiedTweet[] {
    let tweets = [];
    for (let i = 0; i < 10; i++) {
      ...
      tweet.classifiedAt.setMinutes(-randomMinutesDiff);
      tweets.push(tweet);
    }
